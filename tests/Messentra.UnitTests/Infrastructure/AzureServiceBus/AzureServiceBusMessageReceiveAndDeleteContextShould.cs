...
public sealed class AzureServiceBusMessageReceiveAndDeleteContextShould
{
    private readonly Mock<ServiceBusSender> _sender = new();

    private AzureServiceBusMessageReceiveAndDeleteContext CreateSut(ServiceBusReceivedMessage message) =>
