        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Folders_Connections_ConnectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FolderResources", x => new { x.FolderId, x.ResourceUrl });
                    table.ForeignKey(
                        name: "FK_FolderResources_Folders_FolderId",
                        column: x => x.FolderId,
